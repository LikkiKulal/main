      ...
      <div className="p1main">
        ...
        <main className="p2dash">
          <div className="p3content">
            ...
            <section className="p3recent">
              ...
              <div className='emptyT'>
                <img src="/emptyT.svg" alt="" className="icon1" />
                <h1 className='text1'>No Transactions Yet.</h1>
                <h2 className='text2'>Looks like there are no transactions to show here.
                  <br />Please Check back after some time.</h2>
              </div>
          ...
          <section className="p3orders">
            ...
            <div className='emptyO'>
              <img src="/emptyO.svg" alt="" className="icon5" />
              <h1 className='texto1'>No Transactions Yet.</h1>
              <h2 className='texto2'>Looks like there are no transactions to show here.
                <br />Please Check back after some time.</h2>
            </div>
          </section>
        </main>
